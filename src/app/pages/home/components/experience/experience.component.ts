...
export class ExperienceComponent {
  ...
  jobs = [
    ...
    },
    {
      ...
      employer: {
        name: 'Momentum',
        description: 'Insurance company and authorised FSP',
        url: 'https://www.momentum.co.za/',
        type: 'Contract',
      },
      responsibilities: `Momentum had a legacy system that was set to be decommissioned in March 2025. I was tasked to rewrite the Front-end using the latest version of Angular & Angular Material.`,
      skills: [
        'Angular',
        'Angular Material',
        'Typescript',
    ...
    },
    {
      ...
      employer: {
        name: 'Apleona Group',
        description: 'Facilities management company',
    ...
    },
    {
      ...
      employer: {
        name: 'Tracker',
        description: 'Fleet management & vehicle tracking company',
